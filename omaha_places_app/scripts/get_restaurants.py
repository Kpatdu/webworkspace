'''
Modified version of the get_restaurants.py script to grab multiple photos of each location (if available)
'''
...
place_types = ['restaurant', 'bar', 'cafe', 'bakery']
...
def fetch_and_write_to_csv():
    ...
    with open('omaha_places_app/cache/new_restaurants.csv', mode = 'w', newline = '', encoding = 'utf-8') as file:
        ...
        for place_type in place_types:
            ...
            while True:
                ...
                for place in places:
                    ...
                    # Skip adding this place if it has fewer than MIN_PHOTOS_REQUIRED (4)
                    ...
                    phone, website, description = get_restaurant_details(place_id) if place_id else ('N/A', 'N/A', 'No description available')
    ...
    print('Data written to "restaurants.csv" successfully.')
