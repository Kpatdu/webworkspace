...
# OR RUN THE FOLLOWING IN SHELL: exec(open("omaha_places_app/scripts/shell_upload-to-db_places-csv.py").read())

import csv
from omaha_places_app.models import Place

csv_file_path = 'omaha_places_app/cache/new_places.csv'
